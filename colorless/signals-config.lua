...
function signals:init(args)
    ...
    client.connect_signal(
        ...
        function(c)
            ...
            -- startup placement
            if awesome.startup
                and not s.size_hints.user_position
                and not s.size_hints.program_position
            then
    ...
    -- Awesome 4.0 introduce screen handling without restart.
    -- To avoid rework of existing components, we force a restart, when monitors are (dis)connected.
